...
io.on('connection', function(socket) {
  ...
  T.get('search/tweets', { q: '#covid19', count: 100, result_type:'top', lang:'en' }, function(err, data, response) {
    var tweetArray=[];
  ...
  var stream = T.stream('statuses/filter', { track: '#covid19', language: 'en' })
